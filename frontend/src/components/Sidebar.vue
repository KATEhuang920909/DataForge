<template>
  <aside class="hidden md:block w-56 shrink-0 border-r border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30">
...
const popularTags = ['CSV', 'JSON', 'Excel', '示例', 'NLP', '内部']
const formats = [
  { name: 'CSV', ext: '.csv' },
  { name: 'JSON', ext: '.json' },
  { name: 'Excel', ext: '.xlsx' },
